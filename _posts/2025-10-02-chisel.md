...
toc_sticky: true
tags: [cpts, networking, tunneling, pivoting, chisel, socks5]
...
![chisel](/assets/cpts-network/chisel/chisel-connect.png)

## proxychains.conf 설정

연결 성공 후, 로컬의 `/etc/proxychains.conf`(`/etc/proxychains4.conf`)를 편집하여 SOCKS 리스너를 `127.0.0.1:1080`으로 변경했다.

![chisel](/assets/cpts-network/chisel/proxychains.png)
...
![chisel](/assets/cpts-network/chisel/rdp-connect.png)

## Flag 획득

문제에서 제공한 Flag 파일 경로 `C:\Users\victor\Documents\flag.txt`를 읽어 플래그를 획득하였다.

![chisel](/assets/cpts-network/chisel/flag.png)

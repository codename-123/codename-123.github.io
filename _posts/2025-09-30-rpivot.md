...
toc_sticky: true
tags: [cpts, networking, ssh, tunneling, pivoting, socks, reverse]
...
![Rpivot Pivot](/assets/cpts-network/rpivot/rpivot-network.png)
...
![Rpivot Pivot](/assets/cpts-network/rpivot/flag.png)

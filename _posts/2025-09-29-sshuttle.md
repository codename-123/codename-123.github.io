...
toc_sticky: true
tags: [cpts, networking, ssh, tunneling, pivoting, sshuttle]
...
![Sshuttle](/assets/cpts-network/sshuttle/sshuttle-start.png)
...
![Sshuttle](/assets/cpts-network/sshuttle/rdp-connect.png)

## Flag 획득

`victor` 유저 데스크톱에 존재하는 `flag.txt` 파일을 읽어서 플래그를 획득하였다.

![Sshuttle](/assets/cpts-network/sshuttle/flag.png)

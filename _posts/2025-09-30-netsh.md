...
toc_sticky: true
tags: [cpts, networking, windows, netsh, tunneling, pivoting, portforward]
...
![Netsh Port Forward Diagram](/assets/cpts-network/netsh/netsh.png)
...
![Netsh](/assets/cpts-network/netsh/ipconfig.png)
...
![Netsh](/assets/cpts-network/netsh/v4tov4.png)
...
![Netsh](/assets/cpts-network/netsh/rdp-connect.png)

## Flag 획득

데스크톱에 있는 `flag.txt` 파일 내용을 읽어 플래그를 획득하였다.

![Netsh](/assets/cpts-network/netsh/flag.png)

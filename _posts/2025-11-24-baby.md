...
![Baby](/assets/htb-windows/baby/baby.png)
...
![세션 획득](/assets/htb-windows/baby/robinson-shell.png)
...
이후, `Evil-WinRM` 을 통해 대상 시스템에 원격으로 접속을 시도하였으며, **도메인 관리자 권한의 세션 획득**에 성공하였다:

![세션 획득](/assets/htb-windows/baby/admin-shell.png)

최종적으로 `root.txt` 파일을 읽어 플래그를 획득하였다.

![플래그](/assets/htb-windows/baby/flag.png)